...
local plug_map = {
    --  Which Key Menu
    ["n|<A-c>"] = map_cr("WhichKey <~>"):with_noremap():with_silent(),
    -- Neoformat
    ["n|<C-A-l>"] = map_cr("Neoformat"):with_noremap():with_silent(),               --Neoformat file (Like Prettier)
    -- Bufferline
    ["n|gb"] = map_cr("BufferLinePick"):with_noremap():with_silent(),               --Easymotion for Tabs
    ["n|<A-l>"] = map_cr("BufferLineCycleNext"):with_noremap():with_silent(),       --Tabs motion
    ["n|<A-h>"] = map_cr("BufferLineCyclePrev"):with_noremap():with_silent(),       --Tabs motion
    ["n|<A-S-l>"] = map_cr("BufferLineMoveNext"):with_noremap():with_silent(),      --Tabs motion
    ["n|<A-S-h>"] = map_cr("BufferLineMovePrev"):with_noremap():with_silent(),      --Tabs motion
    ["n|<leader>be"] = map_cr("BufferLineSortByExtension"):with_noremap(),          --Sort buffers by type
    ["n|<leader>bd"] = map_cr("BufferLineSortByDirectory"):with_noremap(),          --Sort fuffers by Path
    ["n|<A-1>"] = map_cr("BufferLineGoToBuffer 1"):with_noremap():with_silent(),    --Select Buffer Using Alt Keys
    ...
    -- Packer
    ["n|<leader>ps"] = map_cr("PackerSync"):with_silent():with_noremap()            --PackerSync
        :with_nowait(),
    ["n|<leader>pu"] = map_cr("PackerUpdate"):with_silent():with_noremap()          --PackerSync
        :with_nowait(),
    ["n|<leader>pi"] = map_cr("PackerInstall"):with_silent():with_noremap()         --PackerSync
        :with_nowait(),
    ["n|<leader>pc"] = map_cr("PackerClean"):with_silent():with_noremap()           --PackerSync
        :with_nowait(),
    -- Lsp mapp work when insertenter and lsp start                                 LSP
    ["n|<leader>li"] = map_cr("LspInfo"):with_noremap():with_silent()               --LspInfo
        :with_nowait(),
    ["n|<leader>lr"] = map_cr("LspRestart"):with_noremap():with_silent()            --LspRestart
        :with_nowait(),
    ["n|g["] = map_cr('Lspsaga diagnostic_jump_next'):with_noremap()                --Jump Next
        :with_silent(),
    ["n|g]"] = map_cr('Lspsaga diagnostic_jump_prev'):with_noremap()                --Jump Previous
        :with_silent(),
    ["n|K"] = map_cr("Lspsaga hover_doc"):with_noremap():with_silent(),             --Hover Doc
    ...
    ["n|<C-F12>"] = map_cr('MarkdownPreviewToggle'):with_noremap():with_silent(),
    -- Plugin auto_session
